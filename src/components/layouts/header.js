            ...
            <div className="nav__menu">
              ...
              >
                ...
                <li className="nav__menu--list--item">
                  ...
                  <Link className="ml-1" to="/"> <i className="faShoppingCart"> <FontAwesomeIcon icon={faShoppingCart} /></i></Link>
                  ...
                  <Link className="ml-2" to="/"><i className="faSearch"><FontAwesomeIcon icon={faSearch} /></i></Link>
