  ...
  render() {
    return (
      <header>
        ...
        <nav className="nav">
          <div className="nav__main container dflex justify-content-between align-items-center py-1">
            ...
            <div className="nav__menu">
              <ul className="nav__menu--list list-unstyled dflex justify-content-between align-items-center">
                <li className="nav__menu--list--item">
                  <AniLink
                    ...
                    direction="up"
                    to="/"
                    className="nav__menu--list--item--link"
                  >
                    Home
                  </AniLink>
                </li>
                ...
                <li className="nav__menu--list--item">
                  <a href="tel:+63 917 421 9688">
                    <button className="nav__menu--list--item--button btnHoveringFloat">
                      Call Now
                    </button>
                  </a>
                </li>
